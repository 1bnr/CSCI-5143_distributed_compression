...
#define Fram  0xA0      // device address of EEPROM 24C02, see datasheet
...
int main(void)
{
    ...
    ret = i2c_start(Fram+I2C_WRITE);       // set device address and write mode
    if ( ret ) {
        ...
        i2c_start_wait(Fram+I2C_WRITE);     // set device address and write mode
        i2c_write(0x05);                        // write address = 5
        i2c_rep_start(Fram+I2C_READ);       // set device address and read mode
        ...
        i2c_write(0x50);                        // write data to address 0
        i2c_write(0x51);                        //    "    "   "    "    1
        i2c_write(0x52);                        //    "    "   "    "    2
        i2c_write(0x54);                        //    "    "   "    "    3
        i2c_stop();                             // set stop conditon = release bus
